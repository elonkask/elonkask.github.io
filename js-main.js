    ...
    setTimeout(function () {
      ...
      setTimeout(function () {
        ...
        setTimeout(function () {
          ...
          setTimeout(function () {
            $('.generation-text').html("<span><img src=\"assets/images/points.png\" width=\"25\" class=\"mr-1\"> Points Generating: <span class=\"text-danger counting\">0</span>");
            plusCount(parseInt(selectedPoints), 0x0, '.counting', function () {
              setTimeout(function () {
                $(".generation-text").html("<img src=\"assets/images/points.png\" width=\"25\" class=\"mr-1\"> <span class=\"text-danger\">" + selectedPoints + "</span> <span>points ready!");
                setTimeout(function () {
                  $(".generation-text").html("<img src=\"assets/images/coins.png\" width=\"25\" class=\"mr-1\"> <span class=\"text-danger\">" + selectedCoins + "</span> <span>coins ready!");
                  setTimeout(function () {
...
var generateTemplate = function () {
  ...
  html += "<h4 class=\"text-dark d-flex align-items-center\"><img src=\"assets/images/points.png\" class=\"me-2\" width=\"30\"><span>" + am + '</span></h4>';
  html += "<h4 class=\"text-dark d-flex align-items-center\"><img src=\"assets/images/coins.png\" class=\"me-2\" width=\"30\"><span>" + coints[_0x4b9c3d] + "</span></h4>";
  html += "</div>";
